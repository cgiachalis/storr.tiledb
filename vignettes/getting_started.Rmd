---
title: Getting Started with storr.tiledb
date: "2026-04-06"
vignette: >
  %\VignetteIndexEntry{Getting Started with storr.tiledb}
 ...
 **storr**:  is a key value store interface provided by homonymous R package.
 For implementation details, please refer to [storr](https://richfitz.github.io/storr/articles/storr.html) vignette.
...
hashes
# [1] "20bce84369c17ac389b9b60fe0add435" "632336c518ae1c89ecf26ae5fbec5860"
...
#       <char> <char>              <POSc>
# 1:   objects   key1 2026-04-06 14:09:10
# 2:   objects   key2 2026-04-06 14:10:49
...
#    namespace    key          expires_at
#       <char> <char>              <POSc>
# 1:   objects   key2 2026-04-06 14:10:49
...
Note that we've created a context using`R6.tiledb::new_context()` instead of `tiledb_tiledb_ctx()`, because the latter stores the context to package cache and we do want that on this case.
