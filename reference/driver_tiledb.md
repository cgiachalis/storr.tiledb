...
- **`get_keymeta()`** - Retrieve metadata such as expiry times and notes
  for single key-namespace pairs

- **`mget_keymeta()`** Retrieve metadata such as expiry times and notes
  for multiple key-namespace pairs
