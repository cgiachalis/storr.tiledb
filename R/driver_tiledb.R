...
#'
#' For complete definitions, see **Methods** section in [TileDBDriver] and its
#' parent class [CAS].
#'
#' **Active Fields**
#'
...
#' **Lifecycle**
#'
#' - **`open()`** - Opens the driver for read/write operations
...
#'
#'  - **`get_keymeta()`** - Retrieve metadata such as expiry times and notes for
#'   single key-namespace pairs
#'  - **`mget_keymeta()`**  Retrieve metadata such as expiry times and notes for
#'   multiple key-namespace pairs
...
#' - **`dump()`** - Outputs a string representation of storr structure
#'
#' # Data Model
#'
