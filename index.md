...
across a range of different storage drivers (DBI, LMDB, Redis, RDS,
environment). The `storr` package is written by [Rich
FitzJohn](https://github.com/richfitz).

*What is storr.tiledb?*

The `storr.tiledb` contributes a new storr compliant driver using TileDB
Engine for backend.

It defines a new storr R6 class that leverages the advantages of TileDB
and provides new features such as adding notes and expiration
